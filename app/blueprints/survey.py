...
- 「○○がおいしい」「特に○○が印象的」のような曖昧な表現は絶対に使わないでください
- 具体的な固有名詞（料理名、メニュー名など）は使っても構いません
- 回答された内容に基づいて、具体的に書いてください
- 自由記入欄（テキスト形式の回答）に肯定的な文言が書かれている場合は、その表現を積極的に活用してください
- ただし、自由記入欄の中に「○○」のような曖昧な表現が含まれている場合は、その部分を省略するか、他の具体的な情報を使って書き換えてください
- 自由記入欄の内容はお客様の生の声なので、曖昧な表現を除いた部分はそのまま引用したり、言い換えて使ったりして構いません
...
2. 「○○がおいしい」「特に○○が印象的」「○○が良かった」のような曖昧な表現は絶対に使わないでください
3. 具体的な固有名詞（料理名、メニュー名、店名など）は使っても構いません
4. 回答された内容に基づいて具体的に記述してください
5. 自由記入欄に肯定的な文言があれば、その表現を積極的に活用してください
6. ただし、自由記入欄の中に「○○」のような曖昧な表現が含まれている場合は、その部分を省略するか書き換えてください"""},
